...
export default function StudentDashboard() {
  ...
  const averageScore = submissions.length > 0
    ? Math.round(submissions.reduce((sum, s) => sum + (s.score / s.total_points * 100), 0) / submissions.length)
    : 0;
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between text-xs text-gray-600">
                        <span>{submission.score} / {submission.total_points} points</span>
            ...
            {quizzes.map((quiz) => {
              ...
              return (
                <div key={quiz.id} className="card-hover">
                  ...
                  <p className="text-xs text-gray-500 mb-3 font-medium">{quiz.modules.title}</p>
                  {quiz.description && (
      ...
      {activeSection === 'grades' && (
        <div className="animate-fade-in">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600">View your quiz results and performance</p>
          </div>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">
                          {submission.quizzes.modules.classes.code} - {submission.quizzes.modules.title}
                        </p>
                      </div>
